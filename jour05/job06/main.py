def distance_toilettes_par_semaine(nombre_marches, hauteur_marche):
    ...
    distance_parcourue_par_marche = (nombre_allers_retours_par_jour - 1) * hauteur_marche
    distance_totale_par_semaine = nombre_jours_semaine * nombre_marches * distance_parcourue_par_marche / 100 
